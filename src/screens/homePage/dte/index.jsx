...
const DTE = () => {
  return (
    <section className="py-20 xl:py-28 dte-bg-wrapper ">
      <section className="max-w-screen-xl md:mx-auto md:w-11/12 2xl:w-9/12  bg-white  font-regular text-green flex flex-wrap-reverse dte-master rounded-xl gap-y-3 gap-x-10 px-4 mx-2 ">
