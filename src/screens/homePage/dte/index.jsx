...
export default () =>{
    return(
        ...
        <div className=" flex-1 basis-[20rem] flex flex-col justify-center  gap-3 px-4 md:px-8 lg:px-14  h-[30rem]  xl:h-[40rem]   py-14 xl:py-20 ">
            ...
            <span className="font-subtitle">Boost your cattle's conception rate using digiGAI's DVE. Our Digital Vet Endoscope is designed to keep the biggest challenges of artificial insemination in mind. It helps you gain access to accurate insemination data and live streams the procedure to ensure 100% accuracy and success rate.</span>
        </div>
    </section>
    </section>
    )
