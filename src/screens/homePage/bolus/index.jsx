...
const Bolus = () => {
  return (
    <section className="bolus-bg-wrapper py-20 md:py-32 xl:py-40 ">
      <section className="max-w-screen-2xl md:mx-auto md:w-11/12 2xl:w-9/12  bg-green  font-regular text-white flex flex-wrap bolus-master rounded-xl gap-x-40 px-4 mx-2">
        <div className=" flex-1 basis-[28rem]  flex flex-col justify-center  items-start  gap-2  md:pl-2 lg:pl-6 xl:pl-16 ">
          <h1 className="font-regular font-bold md:py-3 py-2 DigiGAI-Bolus">
            DigiGAI Bolus
          </h1>
          <span className="font-regular DigiGAI-Bolus-para">
