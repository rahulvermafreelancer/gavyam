...
export default () =>{
    return (
        <section className="max-w-screen-2xl bg-green font-regular ">
            <section className="lg:w-10/12 mx-auto  py-6 flex flex-wrap-reverse  items-start gap-6 ">
                <div className=" flex-1 basis-[20rem] flex flex-col justify-start  gap-3 px-4 md:px-8 lg:px-14  h-[25rem]  xl:h-[30rem] py-4 xl:py-10">
                    <h1 className="font-title text-white">INCREASE DAIRY PRODUCTION, WITHOUT RISK OR ERRORS!</h1>
                ...
                <div className="flex-1 basis-[25rem] img-wrapper h-[30rem]  xl:h-[35rem] relative  ">
