    ...
    return (
        <section className="max-w-screen-2xl bg-earth font-regular ">
            <section className="lg:w-10/12 mx-auto  py-6 flex flex-wrap-reverse  items-start gap-6 ">
                <div className=" flex-1 basis-[20rem] flex flex-col justify-start  px-4 md:px-8 lg:px-14  h-[25rem]  xl:h-[30rem] py-4  banner_text_wrapper ">
                ...
                <div className="flex-1 basis-[25rem] img-wrapper h-[30rem] px-4 lg:px-10 rounded-br-[5rem] xl:h-[35rem] relative   ">
